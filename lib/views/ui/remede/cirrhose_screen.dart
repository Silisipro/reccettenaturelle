...
class CirrhoseScreen extends StatefulWidget {
  const CirrhoseScreen({super.key});

  @override
  State<CirrhoseScreen> createState() => _CirrhoseScreenState();
}

class _CirrhoseScreenState extends State<CirrhoseScreen>
