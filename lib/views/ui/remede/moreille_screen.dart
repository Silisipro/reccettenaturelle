...
class MauxDOreilleScreen extends StatefulWidget {
  const MauxDOreilleScreen({super.key});

  @override
  State<MauxDOreilleScreen> createState() => _MauxDOreilleScreenState();
}

class _MauxDOreilleScreenState extends State<MauxDOreilleScreen>
