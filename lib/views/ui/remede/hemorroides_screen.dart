...
class HemorroidesScreen extends StatefulWidget {
  const HemorroidesScreen({super.key});

  @override
  State<HemorroidesScreen> createState() => _HemorroidesScreenState();
}

class _HemorroidesScreenState extends State<HemorroidesScreen>
