...
class InsuffisanceRenaleScreen extends StatefulWidget {
  const InsuffisanceRenaleScreen({super.key});

  @override
  State<InsuffisanceRenaleScreen> createState() => _InsuffisanceRenaleScreenState();
}

class _InsuffisanceRenaleScreenState extends State<InsuffisanceRenaleScreen>
