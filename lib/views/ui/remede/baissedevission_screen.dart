...
class BaisseDeVisionScreen extends StatefulWidget {
  const BaisseDeVisionScreen({super.key});

  @override
  State<BaisseDeVisionScreen> createState() => _BaisseDeVisionScreenState();
}

class _BaisseDeVisionScreenState extends State<BaisseDeVisionScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'BAISSE DE VISION', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """On extrait des feuilles (en faisant bouillir 5 à 10 min) une solution concentrée
                              puis on applique en petites gouttes dans les yeux chaque matin et soir.""",
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Une méthode qui consiste à manger 2 carottes par jour pour améliorer votre
                                vision au bout de quelques jours (à prendre à 18h).""",
                              overflow: TextOverflow.ellipsis,
                              muted: true,
                              textAlign: TextAlign.justify,
                            ),
