...
class UlcereGastroScreen extends StatefulWidget {
  const UlcereGastroScreen({super.key});

  @override
  State<UlcereGastroScreen> createState() => _UlcereGastroScreenState();
}

class _UlcereGastroScreenState extends State<UlcereGastroScreen>
