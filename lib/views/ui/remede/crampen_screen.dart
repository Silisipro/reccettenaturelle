...
class CrampeNocturneScreen extends StatefulWidget {
  const CrampeNocturneScreen({super.key});

  @override
  State<CrampeNocturneScreen> createState() => _CrampeNocturneScreenState();
}

class _CrampeNocturneScreenState extends State<CrampeNocturneScreen>
