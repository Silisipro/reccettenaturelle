...
class MaladiesCardiovasculairesScreen extends StatefulWidget {
  const MaladiesCardiovasculairesScreen({super.key});

  @override
  State<MaladiesCardiovasculairesScreen> createState() => _MaladiesCardiovasculairesScreenState();
}

class _MaladiesCardiovasculairesScreenState extends State<MaladiesCardiovasculairesScreen>
