...
class PreventionCancerScreen extends StatefulWidget {
  const PreventionCancerScreen({super.key});

  @override
  State<PreventionCancerScreen> createState() => _PreventionCancerScreenState();
}

class _PreventionCancerScreenState extends State<PreventionCancerScreen>
