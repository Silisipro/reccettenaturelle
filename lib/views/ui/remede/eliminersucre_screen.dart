...
class EliminerSucreSangScreen extends StatefulWidget {
  const EliminerSucreSangScreen({super.key});

  @override
  State<EliminerSucreSangScreen> createState() => _EliminerSucreSangScreenState();
}

class _EliminerSucreSangScreenState extends State<EliminerSucreSangScreen>
