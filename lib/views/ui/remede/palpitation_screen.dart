...
class PalpitationCardiaqueScreen extends StatefulWidget {
  const PalpitationCardiaqueScreen({super.key});

  @override
  State<PalpitationCardiaqueScreen> createState() => _PalpitationCardiaqueScreenState();
}

class _PalpitationCardiaqueScreenState extends State<PalpitationCardiaqueScreen>
