...
class EternuementsScreen extends StatefulWidget {
  const EternuementsScreen({super.key});

  @override
  State<EternuementsScreen> createState() => _EternuementsScreenState();
}

class _EternuementsScreenState extends State<EternuementsScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'ETERNUEMENTS', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                    ...
                    MyFlexItem(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                             MyText.bodySmall(
                              "Consommer beaucoup d’ail. On y trouve un soulagement étonnant",
