...
import 'package:reccettenaturelle/controller/remede_controller.dart';
...
class RemedeListScreen extends StatefulWidget {
  const RemedeListScreen({super.key});

  @override
  State<RemedeListScreen> createState() => _RemedeListScreenState();
}

class _RemedeListScreenState extends State<RemedeListScreen>
    with SingleTickerProviderStateMixin, UIMixin {
  late RemedeController controller;

  @override
  void initState() {
    controller = Get.put(RemedeController());
    super.initState();
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'Remedes', active: true),
                      ],
                      backRoute: '/acceuil',
                    ),
                    MyText.titleMedium(
                      "REMEDES NATURELLES FAIT MAISON",
                      fontSize: 12,
                      fontWeight: 600,
                    ),
                    ...
                    MyFlexItem(
                      child: Column(
                        ...
                        children: [
                          GridView.builder(
                            shrinkWrap: true,
                            itemCount: controller.remedes['List'].length,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              onTap: () {
                                    final route = controller.remedes['List'][index]['link'];
                                    Get.toNamed(route);
                                  },
                                child: MouseRegion(
                                      ...
                                      children: [
                                        MyContainer(
                                          ...
                                          child: MyText.bodySmall(
                                            controller.remedes['List'][index]['libelle'],
                                            fontWeight: 600,
