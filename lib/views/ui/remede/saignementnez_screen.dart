...
class SaignementDuNezScreen extends StatefulWidget {
  const SaignementDuNezScreen({super.key});

  @override
  State<SaignementDuNezScreen> createState() => _SaignementDuNezScreenState();
}

class _SaignementDuNezScreenState extends State<SaignementDuNezScreen>
