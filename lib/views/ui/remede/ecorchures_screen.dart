...
class EcorchuresScreen extends StatefulWidget {
  const EcorchuresScreen({super.key});

  @override
  State<EcorchuresScreen> createState() => _EcorchuresScreenState();
}

class _EcorchuresScreenState extends State<EcorchuresScreen>
