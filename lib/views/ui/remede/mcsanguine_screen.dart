...
class MauvaiseCirculationSanguineScreen extends StatefulWidget {
  const MauvaiseCirculationSanguineScreen({super.key});

  @override
  State<MauvaiseCirculationSanguineScreen> createState() => _MauvaiseCirculationSanguineScreenState();
}

class _MauvaiseCirculationSanguineScreenState extends State<MauvaiseCirculationSanguineScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: '', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
