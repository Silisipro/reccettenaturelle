...
class MorsureDeSerpentScreen extends StatefulWidget {
  const MorsureDeSerpentScreen({super.key});

  @override
  State<MorsureDeSerpentScreen> createState() => _MorsureDeSerpentScreenState();
}

class _MorsureDeSerpentScreenState extends State<MorsureDeSerpentScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'MORSSURE DE SERPENT', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                          ...
                          children: [
                             Row(
                              children: [
                                ...
                                MySpacing.width(8),
                                MyText.titleSmall(
                                  "Oignon, cola + feuilles de manioc",
                                 fontWeight: 600,
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Ecraser ensemble de l’oignon, du cola plus des feuilles de manioc. Ensuite
                                bien mélanger, et il s’en remettra.""",
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Exciser la partie de la morsure à abstenir des gouttes de sang avec une
                              nouvelle lame et placer la ‘’ pierre noire’’ il aura une attraction.
                              Dès que le venin sera absorbé la pierre noire tombe.
                              NB : La pierre noire extrait également le venin des animaux et le poison des
                              objets (couteaux ou flèches empoisonnés)""",
                              overflow: TextOverflow.ellipsis,
                              muted: true,
                              textAlign: TextAlign.justify,
                            ),
