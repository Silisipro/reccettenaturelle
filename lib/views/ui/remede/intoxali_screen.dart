...
class IntoxicationsAlimentairesScreen extends StatefulWidget {
  const IntoxicationsAlimentairesScreen({super.key});

  @override
  State<IntoxicationsAlimentairesScreen> createState() => _IntoxicationsAlimentairesScreenState();
}

class _IntoxicationsAlimentairesScreenState extends State<IntoxicationsAlimentairesScreen>
