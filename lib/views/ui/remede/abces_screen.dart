...
class AbcesScreen extends StatefulWidget {
  const AbcesScreen({super.key});
         
  @override
  State<AbcesScreen> createState() => _AbcesScreenState();
}

class _AbcesScreenState extends State<AbcesScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'ABCES', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                    ...
                    MyFlexItem(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                             MyText.bodySmall(
                              "Enlever les graines d’une papaye non mure, racler la chair de la papaye par l’intérieur et écraser avec de la potasse. Appliquer sur l’abcès.",
