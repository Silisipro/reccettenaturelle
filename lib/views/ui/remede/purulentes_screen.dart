...
class PlaiesPurulentesScreen extends StatefulWidget {
  const PlaiesPurulentesScreen({super.key});

  @override
  State<PlaiesPurulentesScreen> createState() => _PlaiesPurulentesScreenState();
}

class _PlaiesPurulentesScreenState extends State<PlaiesPurulentesScreen>
