...
class CholecysiteScreen extends StatefulWidget {
  const CholecysiteScreen({super.key});

  @override
  State<CholecysiteScreen> createState() => _CholecysiteScreenState();
}

class _CholecysiteScreenState extends State<CholecysiteScreen>
