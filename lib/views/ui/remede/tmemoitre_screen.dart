...
class TroublesMemoireScreen extends StatefulWidget {
  const TroublesMemoireScreen({super.key});

  @override
  State<TroublesMemoireScreen> createState() => _TroublesMemoireScreenState();
}

class _TroublesMemoireScreenState extends State<TroublesMemoireScreen>
