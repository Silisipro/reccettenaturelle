...
class DetoxifiantScreen extends StatefulWidget {
  const DetoxifiantScreen({super.key});

  @override
  State<DetoxifiantScreen> createState() => _DetoxifiantScreenState();
}

class _DetoxifiantScreenState extends State<DetoxifiantScreen>
