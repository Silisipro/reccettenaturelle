...
class CystiteScreen extends StatefulWidget {
  const CystiteScreen({super.key});

  @override
  State<CystiteScreen> createState() => _CystiteScreenState();
}

class _CystiteScreenState extends State<CystiteScreen>
