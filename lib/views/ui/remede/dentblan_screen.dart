...
class BlanchirDentsScreen extends StatefulWidget {
  const BlanchirDentsScreen({super.key});

  @override
  State<BlanchirDentsScreen> createState() => _BlanchirDentsScreenState();
}

class _BlanchirDentsScreenState extends State<BlanchirDentsScreen>
