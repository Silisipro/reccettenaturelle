...
class VomissementScreen extends StatefulWidget {
  const VomissementScreen({super.key});

  @override
  State<VomissementScreen> createState() => _VomissementScreenState();
}

class _VomissementScreenState extends State<VomissementScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'VOMISSEMENT', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              "Mélanger 2 cuillères à soupe d'argile verte plus demi citron mur plus 2 cuillères à café de miel pur et boire le tout 2 jours, loin du repas.",
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Prendre 1 cuillères de cendre blanche du foyer. Mélanger dans ½ verre d'eau tiède, 
                              laissez macérer ½ heure durant, filtrez dans un linge propre et boire le
                              tout doucement avec 1 petite cuillère. Ce traitement est valable pour tous y
                              compris les femmes enceintes et nourrissons.""",
                              overflow: TextOverflow.ellipsis,
                              muted: true,
                              textAlign: TextAlign.justify,
                            ),
