...
class ImpuissanceSexuelleScreen extends StatefulWidget {
  const ImpuissanceSexuelleScreen({super.key});

  @override
  State<ImpuissanceSexuelleScreen> createState() => _ImpuissanceSexuelleScreenState();
}

class _ImpuissanceSexuelleScreenState extends State<ImpuissanceSexuelleScreen>
