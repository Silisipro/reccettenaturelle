...
class BrulureScreen extends StatefulWidget {
  const BrulureScreen({super.key});

  @override
  State<BrulureScreen> createState() => _BrulureScreenState();
}

class _BrulureScreenState extends State<BrulureScreen>
