...
class GaleScreen extends StatefulWidget {
  const GaleScreen({super.key});

  @override
  State<GaleScreen> createState() => _GaleScreenState();
}

class _GaleScreenState extends State<GaleScreen>
