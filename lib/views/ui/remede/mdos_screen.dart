...
class MalDeDosScreen extends StatefulWidget {
  const MalDeDosScreen({super.key});

  @override
  State<MalDeDosScreen> createState() => _MalDeDosScreenState();
}

class _MalDeDosScreenState extends State<MalDeDosScreen>
