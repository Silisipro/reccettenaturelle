...
class PanarisScreen extends StatefulWidget {
  const PanarisScreen({super.key});

  @override
  State<PanarisScreen> createState() => _PanarisScreenState();
}

class _PanarisScreenState extends State<PanarisScreen>
