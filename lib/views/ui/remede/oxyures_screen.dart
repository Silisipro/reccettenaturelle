...
class OxyuresScreen extends StatefulWidget {
  const OxyuresScreen({super.key});

  @override
  State<OxyuresScreen> createState() => _OxyuresScreenState();
}

class _OxyuresScreenState extends State<OxyuresScreen>
