...
class TuberculoseScreen extends StatefulWidget {
  const TuberculoseScreen({super.key});

  @override
  State<TuberculoseScreen> createState() => _TuberculoseScreenState();
}

class _TuberculoseScreenState extends State<TuberculoseScreen>
