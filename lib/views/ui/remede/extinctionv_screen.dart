...
class ExtinctionDeVoixScreen extends StatefulWidget {
  const ExtinctionDeVoixScreen({super.key});

  @override
  State<ExtinctionDeVoixScreen> createState() => _ExtinctionDeVoixScreenState();
}

class _ExtinctionDeVoixScreenState extends State<ExtinctionDeVoixScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'EXTINCTION DE VOIX', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Si vous êtes aphone, quelques gargarismes avec le suc de chou additionné
                              d’un peu de miel vous rendront la voix""",
