...
class UlcereEstomacScreen extends StatefulWidget {
  const UlcereEstomacScreen({super.key});

  @override
  State<UlcereEstomacScreen> createState() => _UlcereEstomacScreenState();
}

class _UlcereEstomacScreenState extends State<UlcereEstomacScreen>
