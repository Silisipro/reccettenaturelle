...
class LargeOuvertureVaginaleScreen extends StatefulWidget {
  const LargeOuvertureVaginaleScreen({super.key});

  @override
  State<LargeOuvertureVaginaleScreen> createState() => _LargeOuvertureVaginaleScreenState();
}

class _LargeOuvertureVaginaleScreenState extends State<LargeOuvertureVaginaleScreen>
