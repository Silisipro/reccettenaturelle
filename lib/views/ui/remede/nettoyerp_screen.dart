...
class NettoyerPoumonsScreen extends StatefulWidget {
  const NettoyerPoumonsScreen({super.key});

  @override
  State<NettoyerPoumonsScreen> createState() => _NettoyerPoumonsScreenState();
}

class _NettoyerPoumonsScreenState extends State<NettoyerPoumonsScreen>
