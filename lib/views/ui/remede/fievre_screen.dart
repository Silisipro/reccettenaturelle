...
class FievreScreen extends StatefulWidget {
  const FievreScreen({super.key});

  @override
  State<FievreScreen> createState() => _FievreScreenState();
}

class _FievreScreenState extends State<FievreScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'FIEVRE', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Utiliser quelques feuilles de Nîmes en décoction dans 1 litre d’eau et boire à
                              raison de ½ litre par jour.""",
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """• 1 litre d’eau
                                ...
                                • 5 cuillérées à soupe de jus de citron
                                Boire le mélange 2h avant le repas.""",
                              overflow: TextOverflow.ellipsis,
                              muted: true,
                              textAlign: TextAlign.justify,
                            ),
