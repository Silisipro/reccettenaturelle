...
class DentifriceNaturelScreen extends StatefulWidget {
  const DentifriceNaturelScreen({super.key});

  @override
  State<DentifriceNaturelScreen> createState() => _DentifriceNaturelScreenState();
}

class _DentifriceNaturelScreenState extends State<DentifriceNaturelScreen>
