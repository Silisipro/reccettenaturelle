...
class DrepanocytoseScreen extends StatefulWidget {
  const DrepanocytoseScreen({super.key});

  @override
  State<DrepanocytoseScreen> createState() => _DrepanocytoseScreenState();
}

class _DrepanocytoseScreenState extends State<DrepanocytoseScreen>
