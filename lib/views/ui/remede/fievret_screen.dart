...
class FievreTyphoideScreen extends StatefulWidget {
  const FievreTyphoideScreen({super.key});

  @override
  State<FievreTyphoideScreen> createState() => _FievreTyphoideScreenState();
}

class _FievreTyphoideScreenState extends State<FievreTyphoideScreen>
