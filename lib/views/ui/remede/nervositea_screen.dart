...
class NervositeAttaqueDesNerfsScreen extends StatefulWidget {
  const NervositeAttaqueDesNerfsScreen({super.key});

  @override
  State<NervositeAttaqueDesNerfsScreen> createState() => _NervositeAttaqueDesNerfsScreenState();
}

class _NervositeAttaqueDesNerfsScreenState extends State<NervositeAttaqueDesNerfsScreen>
