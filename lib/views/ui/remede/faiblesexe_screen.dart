...
class FaiblesseSexuelleScreen extends StatefulWidget {
  const FaiblesseSexuelleScreen({super.key});

  @override
  State<FaiblesseSexuelleScreen> createState() => _FaiblesseSexuelleScreenState();
}

class _FaiblesseSexuelleScreenState extends State<FaiblesseSexuelleScreen>
