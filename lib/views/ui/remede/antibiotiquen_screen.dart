...
class AntibiotiqueNaturelScreen extends StatefulWidget {
  const AntibiotiqueNaturelScreen({super.key});

  @override
  State<AntibiotiqueNaturelScreen> createState() => _AntibiotiqueNaturelScreenState();
}

class _AntibiotiqueNaturelScreenState extends State<AntibiotiqueNaturelScreen>
