...
class LaTouxScreen extends StatefulWidget {
  const LaTouxScreen({super.key});

  @override
  State<LaTouxScreen> createState() => _LaTouxScreenState();
}

class _LaTouxScreenState extends State<LaTouxScreen>
