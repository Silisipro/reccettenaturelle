...
class DepressionPhysiqueScreen extends StatefulWidget {
  const DepressionPhysiqueScreen({super.key});

  @override
  State<DepressionPhysiqueScreen> createState() => _DepressionPhysiqueScreenState();
}

class _DepressionPhysiqueScreenState extends State<DepressionPhysiqueScreen>
