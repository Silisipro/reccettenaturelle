...
class BronchiteScreen extends StatefulWidget {
  const BronchiteScreen({super.key});

  @override
  State<BronchiteScreen> createState() => _BronchiteScreenState();
}

class _BronchiteScreenState extends State<BronchiteScreen>
