...
class MenopauseScreen extends StatefulWidget {
  const MenopauseScreen({super.key});

  @override
  State<MenopauseScreen> createState() => _MenopauseScreenState();
}

class _MenopauseScreenState extends State<MenopauseScreen>
