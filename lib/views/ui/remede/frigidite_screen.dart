...
class FrigiditeScreen extends StatefulWidget {
  const FrigiditeScreen({super.key});

  @override
  State<FrigiditeScreen> createState() => _FrigiditeScreenState();
}

class _FrigiditeScreenState extends State<FrigiditeScreen>
