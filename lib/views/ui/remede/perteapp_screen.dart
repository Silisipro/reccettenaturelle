...
class PerteAppetitScreen extends StatefulWidget {
  const PerteAppetitScreen({super.key});

  @override
  State<PerteAppetitScreen> createState() => _PerteAppetitScreenState();
}

class _PerteAppetitScreenState extends State<PerteAppetitScreen>
