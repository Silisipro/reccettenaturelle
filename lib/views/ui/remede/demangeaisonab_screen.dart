...
class DemangeaisonApresBainScreen extends StatefulWidget {
  const DemangeaisonApresBainScreen({super.key});

  @override
  State<DemangeaisonApresBainScreen> createState() => _DemangeaisonApresBainScreenState();
}

class _DemangeaisonApresBainScreenState extends State<DemangeaisonApresBainScreen>
              ...
              children: [
                MyBreadcrumb(
                  children: [
                    ...
                    MyBreadcrumbItem(name: 'DEMANGEAISON APRES BAIN', active: true),
                  ],
                   backRoute: '/remedes',
                ),
                MyText.titleMedium(
                  "DEMANGEAISON APRES BAIN",
                  fontSize: 16,
                  fontWeight: 600,
                ),
                      ...
                      child: MyContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              """Découper en quelques morceaux, une partie du tronc de bananier. Mettre
                              dans un canari et faire bouillir pendant 10 min environ. Laisser reposer et se
                              laver avec matin et soir sur 2 ou 3 jours.""",
                            ...
                            MySpacing.height(12),
                             MyText.bodySmall(
                              "Se laver avec l’eau de mer arrête les démangeaisons après bain",
                              overflow: TextOverflow.ellipsis,
                              muted: true,
                              textAlign: TextAlign.justify,
                            ),
