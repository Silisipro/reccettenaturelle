...
class ConvalescenceScreen extends StatefulWidget {
  const ConvalescenceScreen({super.key});

  @override
  State<ConvalescenceScreen> createState() => _ConvalescenceScreenState();
}

class _ConvalescenceScreenState extends State<ConvalescenceScreen>
