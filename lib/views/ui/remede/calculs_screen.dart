...
class CalculsScreen extends StatefulWidget {
  const CalculsScreen({super.key});

  @override
  State<CalculsScreen> createState() => _CalculsScreenState();
}

class _CalculsScreenState extends State<CalculsScreen>
