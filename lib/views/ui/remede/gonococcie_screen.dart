...
class GonococcieScreen extends StatefulWidget {
  const GonococcieScreen({super.key});

  @override
  State<GonococcieScreen> createState() => _GonococcieScreenState();
}

class _GonococcieScreenState extends State<GonococcieScreen>
