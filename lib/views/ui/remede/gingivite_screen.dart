...
class GingiviteScreen extends StatefulWidget {
  const GingiviteScreen({super.key});

  @override
  State<GingiviteScreen> createState() => _GingiviteScreenState();
}

class _GingiviteScreenState extends State<GingiviteScreen>
