...
import 'package:reccettenaturelle/helpers/widgets/my_list_extension.dart';
    ...
    return MyResponsive(
      builder:
        ...
        for (List<MyFlexItem> lCol in getGrouped(screenMediaType)) {
          ...
          //       width, col.flex[screenMediaType] ?? MyScreenMedia.flexColumns, lCol.length,
          //       spacing ?? flexSpacing), child: col,));
          //
          //   // list.add(MySpacing.width(1));
          // }
        }
        return Wrap(
