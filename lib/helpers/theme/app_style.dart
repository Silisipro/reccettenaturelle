...
class AppTheme {
  ...
  static Color primaryColor = Color(0xffffac1c);
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'reccettenaturelle', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
...
class AppColors {
  ...
  static Color notificationErrorActionColor = Color(0xffffac1c);
